...
class ChildMainHistoryPage extends ConsumerStatefulWidget {
  final String? childUuid;

  const ChildMainHistoryPage({super.key, this.childUuid});

  @override
  ConsumerState<ChildMainHistoryPage> createState() => _ChildMainHistoryPageState();
}

class _ChildMainHistoryPageState extends ConsumerState<ChildMainHistoryPage> {
  @override
  void initState() {
    super.initState();
    // 초기 데이터 로드
