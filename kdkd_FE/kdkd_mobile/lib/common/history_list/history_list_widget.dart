    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          if (data.isEmpty) const _EmptyTransactionMessage() else _TransactionList(transactions: data),
        ],
      ),
    );
  }
...
class _TransactionList extends StatelessWidget {
  ...
  // 날짜별로 그룹핑
  Map<String, List<PaymentModel>> _groupByDate() {
    final Map<String, List<PaymentModel>> grouped = {};

    for (final transaction in transactions) {
      final dateKey = '${transaction.transactedAt.month}월 ${transaction.transactedAt.day}일';
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            return _TransactionDayItem(
              date: dayTransactions.first.transactedAt,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            _formatAmount(transaction.paymentBalance),
            style: TextStyle(
              color: transaction.paymentBalance >= 0 ? AppColors.primary : AppColors.grayMedium,
              fontWeight: FontWeight.w600,
              fontSize: 14,
              letterSpacing: -.5,
            ),
